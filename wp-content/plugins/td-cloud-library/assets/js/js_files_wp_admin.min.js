...
(function(){jQuery(".post-type-tdb_templates .page-title-action").addClass("page-title-action-show").click(function(a){a.preventDefault();window.tdbVue.router.push({name:"loadRoute"})})})();
